...
return [
    ...
    'two_factor_lost_fix_self'             => 'If you run your own instance of Captain Money, read <a href="https://docs.firefly-iii.org/faq/other#i-lost-my-two-factor-authentication-codes-and-backup-codes">this entry in the FAQ</a> for instructions.',
    ...
    'mfa_backup_code'                      => 'You have used a backup code to login to Captain Money. It can\'t be used again, so cross it from your list.',
    ...
    'need_more_help'                       => 'If you need more help using Captain Money, please <a href="https://github.com/firefly-iii/firefly-iii/issues">open a ticket on Github</a>.',
    ...
    'cannot_redirect_to_account'           => 'Captain Money cannot redirect you to the correct page. Apologies.',
    ...
    'invalid_locale_settings'              => 'Captain Money is unable to format monetary amounts because your server is missing the required packages. There are <a href="https://docs.firefly-iii.org/firefly-iii/advanced-installation/locales/">instructions how to do this</a>.',
    ...
    'login_page_title'                     => 'Login to Captain Money',
    'register_page_title'                  => 'Register at Captain Money',
    'forgot_pw_page_title'                 => 'Forgot your password for Captain Money',
    'reset_pw_page_title'                  => 'Reset your password for Captain Money',
    ...
    'advanced_options_explain'             => 'Some pages in Captain Money have advanced options hidden behind this button. This page doesn\'t have anything fancy here, but do check out the others!',
    ...
    'attempt_content_help'                 => 'These are all the unsuccessful attempts of this webhook message to submit to the configured URL. After some time, Captain Money will stop trying.',
    ...
    // API access
    'authorization_request'                => 'Captain Money v:version Authorisation Request',
    ...
    'authorization_request_site'           => 'You will be redirected to <code>:url</code> which will then be able to access your Captain Money data.',
    ...
    'cant_logout_guard'                    => 'Captain Money can\'t log you out.',
    'internal_reference'                   => 'Internal reference',

    // check for updates:
    'update_check_title'                   => 'Check for updates',
    'admin_update_check_title'             => 'Automatically check for update',
    'admin_update_check_explain'           => 'Captain Money can check for updates automatically. When you enable this setting, it will contact the Captain Money update server to see if a new version of Captain Money is available. When it is, you will get a notification. You can test this notification using the button on the right. Please indicate below if you want Captain Money to check for updates.',
    'check_for_updates_permission'         => 'Captain Money can check for updates, but it needs your permission to do so. Please go to the <a href=":link">administration</a> to indicate if you would like this feature to be enabled.',
    ...
    'admin_update_check_now_explain'       => 'If you press the button, Captain Money will see if your current version is the latest.',
    'check_for_updates_button'             => 'Check now!',
    'update_new_version_alert'             => 'A new version of Captain Money is available. You are running :your_version, the latest version is :new_version which was released on :date.',
    ...
    'admin_update_channel_explain'         => 'Captain Money has three update "channels" which determine how ahead of the curve you are in terms of features, enhancements and bugs. Use the "beta" channel if you\'re adventurous and the "alpha" when you like to live life dangerously.',
    ...
    'search'                               => 'Search',
    'search_query'                         => 'Query',
    'search_found_transactions'            => 'Captain Money found :count transaction in :time seconds.|Captain Money found :count transactions in :time seconds.',
    'search_found_more_transactions'       => 'Captain Money found more than :count transactions in :time seconds.',
    'search_for_query'                     => 'Captain Money is searching for transactions with all of these words in them: <span class="text-info">:query</span>',
 ...
 */
    ...
    'search_box'                                          => 'Search',
    'search_box_intro'                                    => 'Welcome to the search function of Captain Money. Enter your search query in the box. Make sure you check out the help file because the search is pretty advanced.',
    ...
    'instructions_rule_from_bill'                         => 'In order to match transactions to your new bill ":name", Captain Money can create a rule that will automatically be checked against any transactions you store. Please verify the details below and store the rule to have Captain Money automatically match transactions to your new bill.',
    ...
    'apply_rule_selection_intro'                          => 'Rules like ":title" are normally only applied to new or updated transactions, but you can tell Captain Money to run it on a selection of your existing transactions. This can be useful when you have updated a rule and you need the changes to be applied to all of your other transactions.',
    ...
    'apply_rule_group_selection_intro'                    => 'Rule groups like ":title" are normally only applied to new or updated transactions, but you can tell Captain Money to run all the rules in this group on a selection of your existing transactions. This can be useful when you have updated a group of rules and you need the changes to be applied to all of your other transactions.',
 ...
 */
    ...
    'create_rule_for_bill_txt'                            => 'You have just created a new bill called ":name", congratulations!Captain Money can automagically match new withdrawals to this bill. For example, whenever you pay your rent, the bill "rent" will be linked to the expense. This way, Captain Money can accurately show you which bills are due and which ones aren\'t. In order to do so, a new rule must be created. Captain Money has filled in some sensible defaults for you. Please make sure these are correct. If these values are correct, Captain Money will automatically link the correct withdrawal to the correct bill. Please check out the triggers to see if they are correct, and add some if they\'re wrong.',
    ...
    'pref_languages_help'                       => 'Captain Money supports several languages. Which one do you prefer?',
    'pref_locale_help'                          => 'Captain Money allows you to set other local settings, like how currencies, numbers and dates are formatted. Entries in this list may not be supported by your system. Captain Money doesn\'t have the correct date settings for every locale; contact me for improvements.',
    ...
    'slack_webhook_url_help'                    => 'If you want Captain Money to notify you using Slack, enter the webhook URL here. Otherwise leave the field blank. If you are an admin, you need to set this URL in the administration as well.',
    ...
    // profile:
    'purge_data_title'                          => 'Purge data from Captain Money',
    'purge_data_expl'                           => '"Purging" means "deleting that which is already deleted". In normal circumstances, Captain Money deletes nothing permanently. It just hides it. The button below deletes all of these previously "deleted" records FOREVER.',
    ...
    'delete_data_title'                         => 'Delete data from Captain Money',
    'permanent_delete_stuff'                    => 'You can delete stuff from Captain Money. Using the buttons below means that your items will be removed from view and hidden. There is no undo-button for this, but the items may remain in the database where you can salvage them if necessary.',
    ...
    'delete_your_account_help'                  => 'Deleting your account will also delete any accounts, transactions, <em>anything</em> you might have saved into Captain Money. It\'ll be GONE.',
    ...
    'secure_pw_ff'                              => 'Do you use the same password all over the internet? If one site loses your password, hackers have access to all your data. Captain Money relies on you to choose a strong and unique password to protect your financial records.',
    'secure_pw_check_box'                       => 'To help you do that Captain Money can check if the password you want to use has been stolen in the past. If this is the case, Captain Money advises you NOT to use that password.',
    'secure_pw_working_title'                   => 'How does it work?',
    'secure_pw_working'                         => 'By ticking the box, Captain Money will send the first five characters of the SHA1 hash of your password to <a href="https://www.troyhunt.com/introducing-306-million-freely-downloadable-pwned-passwords/">the website of Troy Hunt</a> to see if it is on the list. This will stop you from using unsafe passwords as is recommended in the latest <a href="https://pages.nist.gov/800-63-3/sp800-63b.html">NIST Special Publication</a> on this subject.',
    ...
    'email_verification'                        => 'An email message will be sent to your old AND new email address. For security purposes, you will not be able to login until you verify your new email address. If you are unsure if your Captain Money installation is capable of sending email, please do not use this feature. If you are an administrator, you can test this in the <a href="admin">Administration</a>.',
    ...
    'external_user_mgt_disabled'                => 'This action is not available when Captain Money isn\'t responsible for user management or authentication handling.',
    'external_auth_disabled'                    => 'This action is not available when Captain Money isn\'t responsible for authentication handling.',
    'delete_local_info_only'                    => "Because Captain Money isn't responsible for user management or authentication handling, this function will only delete local Captain Money information.",
    'oauth'                                     => 'OAuth',
 ...
 */
    ...
    // export data:
    'export_data_title'                         => 'Export data from Captain Money',
    'export_data_menu'                          => 'Export data',
    'export_data_bc'                            => 'Export data from Captain Money',
    'export_data_main_title'                    => 'Export data from Captain Money',
    'export_data_expl'                          => 'This link allows you to export all transactions + meta data from Captain Money. Please refer to the help (top right (?)-icon) for more information about the process.',
    ...
    'currencies_intro'                          => 'Captain Money supports various currencies which you can set and enable here.',
    ...
    'visit_bill'                                => 'Visit bill ":name" at Captain Money',
    ...
    'auto_match_on'                             => 'Automatically matched by Captain Money',
    'auto_match_off'                            => 'Not automatically matched by Captain Money',
    ...
    'bill_edit_rules'                           => 'Captain Money will attempt to edit the rule related to this bill as well. If you\'ve edited this rule yourself however, Captain Money won\'t change anything.|Captain Money will attempt to edit the :count rules related to this bill as well. If you\'ve edited these rules yourself however, Captain Money won\'t change anything.',
    ...
    'cash'                                      => 'cash',
    'cant_find_redirect_account'                => 'Captain Money tried to redirect you but couldn\'t. Sorry about that. Back to the index.',
    ...
    'reconcile_has_more'                        => 'Your Captain Money ledger has more money in it than your bank claims you should have. There are several options. Please choose what to do. Then, press "Confirm reconciliation".',
    'reconcile_has_less'                        => 'Your Captain Money ledger has less money in it than your bank claims you should have. There are several options. Please choose what to do. Then, press "Confirm reconciliation".',
    'reconcile_is_equal'                        => 'Your Captain Money ledger and your bank statements match. There is nothing to do. Please press "Confirm reconciliation" to confirm your input.',
 ...
 */
    ...
    // new user:
    'welcome'                                   => 'Welcome to Captain Money!',
    'submit'                                    => 'Submit',
    'submission'                                => 'Submission',
    'submit_yes_really'                         => 'Submit (I know what I\'m doing)',
    'getting_started'                           => 'Getting started',
    'to_get_started'                            => 'It is good to see you have successfully installed Captain Money. To get started with this tool please enter your bank\'s name and the balance of your main current account. Do not worry yet if you have multiple accounts. You can add those later. It\'s just that Captain Money needs something to start with.',
    'savings_balance_text'                      => 'Captain Money will automatically create a savings account for you. By default, there will be no money in your savings account, but if you tell Captain Money the balance it will be stored as such.',
    'finish_up_new_user'                        => 'That\'s it! You can continue by pressing <strong>Submit</strong>. You will be taken to the index of Captain Money.',
    'stored_new_accounts_new_user'              => 'Yay! Your new accounts have been stored.',
    'set_preferred_language'                    => 'If you prefer to use Captain Money in another language, please indicate so here.',
    'language'                                  => 'Language',
    ...
    'interest_period_help'                      => 'This field is purely cosmetic and won\'t be calculated for you. As it turns out banks are very sneaky so Captain Money never gets it right.',
 ...
 */
    ...
    'invite_new_user_text'                     => 'As an administrator, you can invite users to register on your Captain Money administration. Using the direct link you can share with them, they will be able to register an account. The invited user and their invite link will appear in the table below. You are free to share the invitation link with them.',
    'invited_user_mail'                        => 'Email address',
    'invite_user'                              => 'Invite user',
    'user_is_invited'                          => 'Email address ":address" was invited to Captain Money',
    ...
    'firefly_instance_configuration'           => 'Configuration options for Captain Money',
    'setting_single_user_mode'                 => 'Single user mode',
    'setting_single_user_mode_explain'         => 'By default, Captain Money only accepts one (1) registration: you. This is a security measure, preventing others from using your instance unless you allow them to. Future registrations are blocked. When you untick this box, others can use your instance as well, assuming they can reach it (when it is connected to the internet).',
    ...
    'admin_maintanance_expl'                   => 'Some nifty buttons for Captain Money maintenance',
    ...
    'admin_notification_check_invite_created'  => 'A user is invited to Captain Money',
    ...
    'select_transaction_to_link'            => 'Select a transaction to link this transaction to. The links are currently unused in Captain Money (apart from being shown), but I plan to change this in the future. Use the search box to select a transaction either by title or by ID. If you want to add custom link types, check out the administration section.',
    ...
    'no_accounts_imperative_asset'          => 'To start using Captain Money you must create at least one asset account. Let\'s do so now:',
    ...
    'no_recurring_intro_default'            => 'You have no recurring transactions yet. You can use these to make Captain Money automatically create transactions for you.',
    ...
    'warning_duplicates_repetitions'        => 'In rare instances, dates appear twice in this list. This can happen when multiple repetitions collide. Captain Money will always generate one transaction per day.',
    ...
    'recurring_never_cron'                  => 'It seems the cron job that is necessary to support recurring transactions has never run. This is of course normal when you have just installed Captain Money, but this should be something to set up as soon as possible. Please check out the help-pages using the (?)-icon in the top right corner of the page.',
    ...
    'help_first_date_no_past'            => 'Indicate the first expected recurrence. Captain Money will not create transactions in the past.',
    ...
    'help_weekend'                       => 'What should Captain Money do when the recurring transaction falls on a Saturday or Sunday?',
 ...
 */
    ...
    'object_groups_empty_explain'        => 'Some things in Captain Money can be divided into groups. Piggy banks for example, feature a "Group" field in the edit and create screens. When you set this field, you can edit the names and the order of the groups on this page. For more information, check out the help-pages in the top right corner, under the (?)-icon.',
